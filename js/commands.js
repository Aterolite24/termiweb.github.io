...
coorps = [
  '<header><div class=\"header-top\"> <div class=\"container\"> <div class=\"header-alert-news\" style=\"font-size: var(--fs-9) !important;\"> <p class="headerp"><b>Aterolite24</b> (ASG) Beyond Corporation. All dreams unreserved.</p> </div> <ul class=\"header-social-container\"> <li> <a href=\" '+github+'\" target="_blank" class=\"social-link\"> <ion-icon name=\"logo-github\" role=\"img\" class=\"md hydrated\" aria-label=\"logo github\"></ion-icon> </a> </li> <li> <a href=\" '+ leetcode +'\"target="_blank" class=\"social-link\"> <ion-icon src="./img/leetcode.png" aria-label="logo LeetCode"></ion-icon> </ion-icon> </a> </li> <li> <a href=\" '+ instagram+ '\"target="_blank" class=\"social-link\"> <ion-icon name=\"logo-instagram\" role=\"img\" class=\"md hydrated\" aria-label=\"logo instagram\"></ion-icon> </a> </li> <li> <a href=\" ' + linkedin + ' \"target="_blank" class=\"social-link\"> <ion-icon name=\"logo-linkedin\" role=\"img\" class=\"md hydrated\" aria-label=\"logo linkedin\"></ion-icon> </a> </li> </ul> </div> </div><div class=\"header-main\"> <div class=\"container\"><div class=\"terminalIcon\"><ion-icon name=\"terminal-outline\" class=\"terminal-outline\"></ion-icon> </div><div class=\"header-user-actions\"><span class=\"usernn\"> '+ greeting + '</span></div</div> </div></header>'
]
